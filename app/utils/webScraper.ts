...
// Enhanced Claude prompt generation with error-safe web scraping integration

// Import functions from webScraper.ts
import { 
  scrapeWebsiteBasic, 
...
// Enhanced main function with proper multi-platform scraping integration
...
- Include specific location details with proper Māori place names where appropriate\n`
  ...
  // Final instructions with brand consistency
...
// Enhanced content generation with multi-platform brand intelligence
