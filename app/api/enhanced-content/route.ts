...
function generatePressRelease(story: string, title: string, company: string, date: string): string {
...
function generateEmailNewsletter(story: string, title: string, profile: any): string {
...
function generateStaffNews(story: string, title: string, date: string): string {
...
function generateBoardReport(story: string, title: string, date: string): string {
  return `BOARD REPORT
...
function generateStakeholderLetter(story: string, title: string, company: string, date: string): string {
  return `${company}
[Address Line 1]
[Address Line 2]
...
function generatePDFContent(story: string, title: string, profile: any): string {
...
function generateWordContent(story: string, title: string, profile: any): string {
  return `${title}
