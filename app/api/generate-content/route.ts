// Fixed AI Content Generation Page: /app/dashboard/create/generate/page.tsx
'use client'
...
export default function AIContentGeneration() {
  ...
  const generateContent = async () => {
    try {
      ...
      // Get stored data from previous steps - FIX LOCALSTORAGE KEYS
      const audience = localStorage.getItem('selectedAudience') || 'General tourism audience'
      const interestsData = localStorage.getItem('selectedInterests')
      const interests = interestsData ? JSON.parse(interestsData)[0] : 'Cultural experiences'
      const persona = localStorage.getItem('selectedPersona') || localStorage.getItem('userPersona') || 'casual'
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: 'white', color: BRAND_PURPLE, borderRadius: '1rem',
